...
class Sales_order_item_model extends CORE_Model
{
    ...
    function get_products_with_balance_qty($sales_order_id){
        $sql="SELECT o.*,(o.so_line_total-o.non_tax_amount)as tax_amount FROM
                ...
                FROM
                (SELECT main.*,(main.so_tax_rate/100)as tax_rate_decimal,p.product_code,p.product_desc,p.unit_id,u.unit_name FROM
                ...
                (
                    ...
                    soi.so_price,soi.so_discount,soi.so_tax_rate FROM sales_order as so
                    ...
                    0 as so_price,0 as so_discount,0 as so_tax_rate FROM (sales_invoice as si
