...
<div id="div_payable_list">
    ...
    <div class="panel-group panel-default" id="accordionA">
        ...
        <div class="panel panel-default">
            <a data-toggle="collapse" data-parent="#accordionA" href="#collapseOne"><div class="panel-heading"><h2 style="font-family:tahoma;">Cash Receipt Journal</h2></div></a>
        ...
        <div class="panel-heading">
            ...
            <div class="tab-container tab-left tab-default">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#supplier_info" data-toggle="tab"><i class="fa fa-bars"></i> Cash Receipt</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="supplier_info" style="min-height: 300px;">
                        ...
                        <form id="frm_journal" role="form" class="form-horizontal">
                            ...
                            <span><strong><i class="fa fa-bars"></i> Transaction Info</strong></span>
                            <hr />
