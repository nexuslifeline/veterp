...
<div class="tab-pane active" id="journal_review_<?php echo $sales_info->sales_invoice_id; ?>" style="min-height: 300px;">
    ...
    <div style="margin-left: 2%">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <i class="fa fa-phone-square"></i> Telephone : <?php echo $sales_info->landline; ?><br />
                <br />
