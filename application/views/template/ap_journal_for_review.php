            ...
            <td>
                ...
                <div class="tab-container tab-left tab-default">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="journal_review_<?php echo $purchase_info->dr_invoice_id; ?>" style="min-height: 300px;">
                                ...
                                <div style="margin-left: 2%">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <i class="fa fa-phone-square"></i> Telephone : <?php echo $purchase_info->landline; ?><br />
                                            <br />
