                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    ...
                                    <div style="margin-left: 10%">
                                        ...
                                        <i class="fa fa-phone-square"></i> Landline : <?php echo $supplier_info->landline; ?><br />
                                        <i class="fa fa-mobile-phone"></i> Mobile Nos. : <?php echo $supplier_info->mobile_no; ?><br /><br /><br />
