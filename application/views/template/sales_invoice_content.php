        ...
        <div class="row">
            ...
            <table class="" width="100%" style="border: 2px solid #757575">
                <tr>
                    ...
                    <td class="table-cellpadding" width="30%"><strong><?php echo $sales_info->customer_name; ?></strong></td>
        ...
        <table width="100%" cellpadding="10" class="table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="10%" class="table-cellpadding tbl-border-si tbl-center"><?php echo number_format($item->inv_qty,2); ?></td>
                    <td width="10%" class="table-cellpadding tbl-border-si tbl-center"><?php echo $item->unit_name; ?></td>
