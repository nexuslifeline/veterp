                                        ...
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="boldlabel">* Product Description :</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="product_name" class="form-control" data-error-msg="Product Description is required." required>
                                                </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom:0px;">
                                            <label class="boldlabel">* Description :</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="product_desc" class="form-control" data-error-msg="Description is required." required>
                                                </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom:0px;">
