                ...
                <div id="div_payable_list">
                    ...
                    <div class="panel-group panel-default" id="accordionA">
                        ...
                        <div class="panel panel-default">
                            <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo"><div class="panel-heading"><h2>Pending Accounts Payable</h2></div></a>
                            <div id="collapseTwo" class="collapse">
                                <div class="panel-body">
                                    <table id="tbl_purchase_review" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                        <tr>
                                            <th></th>
                                            <th>Invoice #</th>
                        ...
                        <div class="panel panel-default">
                            <a data-toggle="collapse" data-parent="#accordionA" href="#collapseOne"><div class="panel-heading"><h2 style="font-family:tahoma;">Accounts Payable Journal</h2></div></a>
                            <div id="collapseOne" class="collapse in">
                                <div class="panel-body" style="min-height: 400px;">

                                        <table id="tbl_account_payables" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                                <th></th>
                                                <th>Txn #</th>
